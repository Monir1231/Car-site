  ...
  return (
    <div className="md:mt-16 mt-10">
      <div className=" flex items-center justify-between">
        ...
        <button
          onClick={loadview}
          className=" md:text-base text-sm font-semibold text-primary"
        >
          View All       
        </button>
      </div>
      ...
      <div className=" mt-10">
        ...
        <div className=" mt-6 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 md:gap-7 gap-7">
          {NotFilterCar.slice(0, visibleCar).map((Allcar) => (
            <ProductAll key={Allcar.id} Allcar={Allcar} />
          ))}
        </div>
        {/* load moro  */}

        {visibleCar < NotFilterCar.length && (
          <div
